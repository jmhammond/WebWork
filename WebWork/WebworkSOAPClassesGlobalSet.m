/*
	...
	The implementation of properties and methods for the WebworkSOAPClassesGlobalSet object.
	Generated by SudzC.com
*/
#import "WebworkSOAPClassesGlobalSet.h"

@implementation WebworkSOAPClassesGlobalSet
	...
	+ (WebworkSOAPClassesGlobalSet*) newWithNode: (CXMLNode*) node
	{
		...
		return (WebworkSOAPClassesGlobalSet*)[[[WebworkSOAPClassesGlobalSet alloc] initWithNode: node] autorelease];
	}
	...
	{
		return [self serialize: @"WebworkSOAPClassesGlobalSet"];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[WebworkSOAPClassesGlobalSet class]]) {
