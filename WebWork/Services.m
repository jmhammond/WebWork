...
@synthesize webworkSOAPHandlerService;
...
-(void)updateServices{
	...
	[self updateService: self.webworkSOAPHandlerService];
}
...
-(WebworkSOAPHandlerService*)webworkSOAPHandlerService{
	if(webworkSOAPHandlerService == nil) {
		webworkSOAPHandlerService = [[WebworkSOAPHandlerService alloc] init];
	}
	return webworkSOAPHandlerService;
}
